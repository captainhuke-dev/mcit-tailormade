...
<title>รายงานเงินมัดจำประจำวัน — P032</title>
<style>
...
(function () {
  ...
  if (!dateFrom || !dateTo) {
    info.textContent = "❌ ไม่มีเงื่อนไขวันที่ — กดพิมพ์จากหน้า P032";
    container.innerHTML = '<div class="report-page"><div class="rep-empty">ไม่มีเงื่อนไขวันที่ — กดปุ่ม "พิมพ์รายงาน" จากหน้า P032</div></div>';
    return;
  }

  fetch("../api/p032_deposits.php", {
    method: "POST",
    ...
    probe.innerHTML =
      '<h1 class="rep-title">รายงานเงินมัดจำประจำวัน</h1>' +
      '<div class="rep-meta">' +
      ...
      '<table style="width:100%;border-collapse:collapse;font-size:12px">' +
        '<thead><tr>' +
          '<th class="c" style="width:4.78%">ลำดับ</th><th class="l" style="width:11.46%">เลขที่เช็ค</th>' +
          '<th class="c" style="width:9.36%">วันที่เช็ค</th><th class="c" style="width:9.46%">รหัสลูกค้า</th>' +
          '<th class="l" style="width:20.06%">ชื่อลูกค้า</th><th class="l" style="width:20.06%">บัญชี</th>' +
          '<th class="r" style="width:9.07%">จำนวนเงิน</th><th class="r" style="width:6.21%">ส่วนลด</th>' +
          '<th class="c" style="width:9.55%">ผู้ตรวจสอบ</th>' +
        '</tr></thead><tbody>' +
    ...
    var headHtml =
      ...
      "<table>" +
        "<thead><tr>" +
          '<th class="c" style="width:4.78%">ลำดับ</th>' +
          '<th class="l" style="width:11.46%">เลขที่เช็ค</th>' +
          '<th class="c" style="width:9.36%">วันที่เช็ค</th>' +
          '<th class="c" style="width:9.46%">รหัสลูกค้า</th>' +
          '<th class="l" style="width:20.06%">ชื่อลูกค้า</th>' +
          '<th class="l" style="width:20.06%">บัญชี</th>' +
          '<th class="r" style="width:9.07%">จำนวนเงิน</th>' +
          '<th class="r" style="width:6.21%">ส่วนลด</th>' +
          '<th class="c" style="width:9.55%">ผู้ตรวจสอบ</th>' +
        "</tr></thead>";
